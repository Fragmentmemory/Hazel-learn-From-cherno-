...
namespace Wizar {
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		WZ_CORE_INFO("Creating window {0} ({1}, {2})", props.Title, props.Width, props.Height);

		if (s_GLFWWindowCount == 0)
		{
			//TODO: glfwTerminate on system shutdown
			WZ_CORE_INFO("Initializing GLFW");
			int success = glfwInit();
			WZ_CORE_ASSERT(success, "Could not intialize GLFW!");
